    ...
    return !loading && <div className="bg-secondary text-black flex flex-col h-screen p-8 md:p-0">
        <div className="grid h-full lg:grid-cols-2">
            <div className="flex flex-col h-full md:p-12">
                ...
                <motion.div className="h-full min-w-[28rem] lg:w-[70%] flex flex-col gap-y-8 justify-center items-start"
                    variants={containerVariants}
                    initial="hidden"
                    animate="visible">
                    <motion.p className="text-5xl lg:text-5xl font-bold"
                        variants={dropUpVariants}
                    ><span className="text-accent">Start</span> your journey with us</motion.p>
                    <motion.p className="text-lg lg:text-xl opacity-70" variants={dropUpVariants}
                    >Begin your educational escapade with us today and turn every lesson into a sensational adventure</motion.p>
                    <motion.button className="text-lg lg:text-xl flex items-center bg-primary text-white py-3 px-8 rounded-2xl mr-auto" onClick={handleClick} variants={dropUpVariants}>
                        <FcGoogle />
